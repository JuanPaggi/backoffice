...
abstract class table
{
    ...
    static public function getUniqueObject($pk, $adding = null, $arrayExec = array(), $style = PDO::FETCH_ASSOC)
    {
        $data = self::getUnique($adding, $arrayExec, $style);
        $tname = self::tablename();
        $Oreturn = new $tname($data[$pk]);
        $Oreturn->void = $data ? $Oreturn->void : true;
        return $Oreturn;
    }
